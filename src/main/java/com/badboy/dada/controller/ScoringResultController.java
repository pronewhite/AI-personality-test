...
import com.badboy.dada.model.dto.scoringResult.ScoringResultAddRequest;
import com.badboy.dada.model.dto.scoringResult.ScoringResultEditRequest;
import com.badboy.dada.model.dto.scoringResult.ScoringResultQueryRequest;
import com.badboy.dada.model.dto.scoringResult.ScoringResultUpdateRequest;
...
//        scoringResultService.validScoringResult(scoringResult, true);
        ...
        // 写入数据库
        boolean result = scoringResultDao.save(scoringResult);
    ...
    public BaseResponse<Boolean> deleteScoringResult(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 判断是否存在
        ScoringResult oldScoringResult = scoringResultDao.getById(id);
        ...
        // 操作数据库
        boolean result = scoringResultDao.removeById(id);
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
...
//        scoringResultService.validScoringResult(scoringResult, false);
        ...
        ThrowUtils.throwIf(oldScoringResult == null, ErrorCode.NOT_FOUND_ERROR);
        // 操作数据库
        boolean result = scoringResultDao.updateById(scoringResult);
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
        return ResultUtils.success(true);
    }
    ...
    public BaseResponse<ScoringResultVO> getScoringResultVOById(long id, HttpServletRequest request) {
        ...
        // 查询数据库
        ScoringResult scoringResult = scoringResultDao.getById(id);
    ...
    public BaseResponse<Page<ScoringResult>> listScoringResultByPage(@RequestBody ScoringResultQueryRequest scoringResultQueryRequest) {
        ...
        // 查询数据库
        Page<ScoringResult> scoringResultPage = scoringResultDao.page(new Page<>(current, size),
